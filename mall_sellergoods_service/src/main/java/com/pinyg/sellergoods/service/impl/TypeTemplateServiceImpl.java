...
import com.pinyg.mapper.TbTypeTemplateMapper;
import com.pinyg.pojo.TbTypeTemplate;
import com.pinyg.pojo.TbTypeTemplateExample;
import com.pinyg.pojo.TbTypeTemplateExample.Criteria;
...
public class TypeTemplateServiceImpl implements TypeTemplateService {
	...
	private void saveToRedis(){
		...
		for(TbTypeTemplate typeTemplate :typeTemplateList){
			...
			//存储规格列表
			List<Map> specList = selectSpecList(typeTemplate.getId());//根据模板ID查询规格列表
